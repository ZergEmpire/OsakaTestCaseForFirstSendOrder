...
public class TestBase {
    ...
    public void setUp() {
        ...
        capabilities.setCapability("videoName", "OsakaTestCaseForFirstSendOrder.mp4");
        capabilities.setCapability("name", "OsakaTestCaseForFirstSendOrder");
